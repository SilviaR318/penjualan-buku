...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jan 2022 pada 05.37
...
(18, 'bg3.jpg', 'Selamat Tinggal', 'Buku ini menceritakan tentang ....', 'Tere Liye', ' Gramedia Pustaka Ut', 26, 79000),
(29, 'bg7.jpeg', 'Pergi', 'Sebuah kisah tentang menemukan tujuan, ke mana hendak pergi, ', 'Tere Liye', ' Sabak Grip Nusantar', 100, 89000),
(33, 'bg1.jpg', 'Wingit', 'buku wingit', 'Sara wijayanto', 'Elex Media', 19, 65000),
...
(36, 'bg6.jpg', 'Tuhan, kenapa kau memberiku wajah ini?', 'Buku Keren', 'Isa Alamsyah', 'Elex Media', 20, 90000),
...
(42, 'bg13.jpg', 'bebass', 'Buku ini cerita yang tidak umum, logis tapi liar. Tutur penulian hebat, Imajinasi digiring terus berkeliling jauh', 'nanda prasetya', 'Sinar gfggfsfsfsf', 100, 180000);
...
INSERT INTO `penerbit` (`kd_penerbit`, `kd_buku`, `penerbit`, `judul`) VALUES
(4, 42, 'Sinar gfggfsfsfsf', 'bebass');
...
--
ALTER TABLE `buku`
  MODIFY `kd_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `penerbit`
  MODIFY `kd_penerbit` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `penerbit`
  ADD CONSTRAINT `penerbit` FOREIGN KEY (`kd_buku`) REFERENCES `buku` (`kd_buku`) ON DELETE CASCADE ON UPDATE CASCADE;

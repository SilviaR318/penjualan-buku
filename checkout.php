      ...
      <section class="section2">
        <div class="card border-0 shadow-sm mt-3">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="radio" id="pilihRadio" name="radio1" value="Bank" /><img src="asset/logoBank.png" width="100px" >
                <input type="radio" id="pilihRadio" name="radio2" value="Gopay" /><img src="asset/logoGopay.png" width="100px">
                <input type="radio" id="pilihRadio" name="radio3" value="Virtual"/><img src="asset/logoVirtual.png" width="150px">
              </div>
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="number" class="form-control" placeholder="ZIP / Postal Code" />
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-2">
                <label class="radio">
                  <input type="radio" name="gender" value="Free Shipping" checked>
              ...
              <div class="col-md-4">
                <label class="radio">
                  <input type="radio" name="gender" value="Next Day Delivery - $20">
